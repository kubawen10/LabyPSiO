...
public class WeatherDownloader {
    ...
    //przetestowac te dwie metody
    WeatherObject getByCityName(UrlObject urlObject) throws HTTPException {
    ...
    WeatherObject getByCoordinates(UrlObject urlObject) throws HTTPException{
